...
//import com.example.cityguidy.AddNew.AddNewCar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new AddsListAdapter(Car.this, mUploads);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Car.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircular.setVisibility(View.INVISIBLE);
...
//                        startActivity(new Intent(getApplicationContext(), AddNewCar.class));
                        break;
