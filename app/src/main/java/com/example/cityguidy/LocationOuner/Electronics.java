...
import com.example.cityguidy.AddNew.addNewElectronics;
...
//                adapter = new AddsListAdapter(Electronics.this, mUploads);
...
//        Collections.sort(mUploads);
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Electronics.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircular.setVisibility(View.INVISIBLE);
...
//        add post
        add_post.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), addNewElectronics.class));
