...
//import com.example.cityguidy.AddNew.AddNewHouse;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new AddsListAdapter(House.this, mUploads);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(House.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircular.setVisibility(View.INVISIBLE);
...
//                        startActivity(new Intent(getApplicationContext(), AddNewHouse.class));
                        break;
