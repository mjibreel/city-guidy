...
public class AddNewCar extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("New Adds").child("Car");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("New Adds").child("Car");
...
//        spn_label_Category
        ...
        customList.add(new CustomItem("Repairing", R.drawable.restaurant_icon));
        customList.add(new CustomItem("Rent", R.drawable.hospital_icon));
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(AddNewCar.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                } else {
...
//    upload Files to data base
    ...
    private void uploadFile() {
        if (mImageUri != null) {
            StorageReference fileReference = mStorageRef.child("Car").child(System.currentTimeMillis()
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(AddNewCar.this, "Upload Successful", Toast.LENGTH_SHORT).show();
