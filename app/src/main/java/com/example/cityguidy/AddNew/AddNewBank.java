...
public class AddNewBank extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("New Adds").child("Bank");
...
//        spn_label_Category
        ...
        customList.add(new CustomItem("Money Transfer", R.drawable.choose_category_icon));
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(AddNewBank.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                } else {
...
//    upload Files to data base
    ...
    private void uploadFile() {
        if (mImageUri != null) {
            StorageReference fileReference = mStorageRef.child("Bank").child(System.currentTimeMillis()
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(AddNewBank.this, "Upload Successful", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(AddNewBank.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
...
//    check the Internet
    ...
    private void showCustomDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(AddNewBank.this);
