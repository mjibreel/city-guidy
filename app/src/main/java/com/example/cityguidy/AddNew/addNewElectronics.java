...
public class addNewElectronics {
   ...
   /* private Spinner spn_label_Category, spn_label_Section, spinnerCity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_new_electronics);
...
//        aTime.setText(timeDate);
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("New Adds").child("Electronics");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("New Adds").child("Electronics").push();
...
//        spn_text_Category = findViewById(R.id.spinner_label_text);
        ...
        customList.add(new CustomItem("Tv", R.drawable.choose_category_icon));
        customList.add(new CustomItem("Refrigerator ", R.drawable.hotel_icon));
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(addNewElectronics.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                    ...
                    *//*final StorageReference fileReference = mStorageRef.child(mImageUri.getLastPathSegment());
                    ...
                    Toast.makeText(addNewElectronics.this, "Upload Successful", Toast.LENGTH_SHORT).show();

                    Intent intent = new Intent(addNewElectronics.this, Electronics.class);
...
//                            add(uploadsAdds);
                        ...
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(addNewElectronics.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }).addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onProgress(@NonNull UploadTask.TaskSnapshot taskSnapshot) {
...
//    check the Internet
    ...
    private void showCustomDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(addNewElectronics.this);
