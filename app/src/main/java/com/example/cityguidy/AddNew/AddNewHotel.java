...
import com.example.cityguidy.LocationOuner.Hotel;
...
public class AddNewHotel extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
...
//        spn_label_Category
        ...
        customList.add(new CustomItem("5 Star", R.drawable.choose_category_icon));
        customList.add(new CustomItem("4 Star", R.drawable.hotel_icon));
        customList.add(new CustomItem("3 Star", R.drawable.restaurant_icon));
        customList.add(new CustomItem("2 Star", R.drawable.hospital_icon));
        customList.add(new CustomItem("1 Star", R.drawable.bank_icon));
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(AddNewHotel.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                } else {
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(AddNewHotel.this, "Upload Successful", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(AddNewHotel.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
...
//    check the Internet
    ...
    private void showCustomDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(AddNewHotel.this);
