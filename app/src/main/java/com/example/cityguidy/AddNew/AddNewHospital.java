...
public class AddNewHospital extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("New Adds").child("Hospital");
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(AddNewHospital.this, "Upload in progress", Toast.LENGTH_SHORT).show();
                } else {
...
//    upload Files to data base
    ...
    private void uploadFile() {
        if (mImageUri != null) {
            StorageReference fileReference = mStorageRef.child("Hospital").child(System.currentTimeMillis()
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(AddNewHospital.this, "Upload Successful", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(AddNewHospital.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
...
//    check the Internet
    ...
    private void showCustomDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(AddNewHospital.this);
